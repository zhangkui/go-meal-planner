...
./build_benzhi_docker.sh go-meal-planner-bug5-candidate linux/amd64
docker run --rm -it go-meal-planner-bug5-candidate:latest
./build_benzhi_docker.sh go-meal-planner-bug5-candidate-arm64 linux/arm64
docker run --rm -it --platform linux/arm64 go-meal-planner-bug5-candidate-arm64:latest
`
