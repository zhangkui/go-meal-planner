...
./build_benzhi_docker.sh go-meal-planner-bug1-candidate linux/amd64
docker run --rm -it go-meal-planner-bug1-candidate:latest
./build_benzhi_docker.sh go-meal-planner-bug1-candidate-arm64 linux/arm64
docker run --rm -it --platform linux/arm64 go-meal-planner-bug1-candidate-arm64:latest
`
